        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="d-flex breadcrumb-content">
                <div class="page-header">
                    ...
                    <div class="page-title">Create Prescription</div>
    ...
    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 page-title-wrapper">
        <div class="row align-items-center">
            <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search align-self-center">
                <div class="inner-page-title pt-1">Create Prescription</div>
            </div>
        </div>
<form action="{{ route('allPrescriptionStore')}}" method="POST">    
     @csrf
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="doc-container">
            <div class="row">
                        ...
                        <div class="invoice-address-company-fields">
                            <div class="form-group row mt-2">
                                <div class="col-md-4 col-sm-12">   
                                    ...
                                    <option disabled="disabled" selected>Choose Patient *</option>
                                ...
                                <div class="col-md-6 col-sm-8">
                                    <input type="text" name="content" class="form-control" placeholder="Patient Info">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="invoice-actions-btn">
                    <div class="invoice-action-btn">
                        <h4>Add Medicine Items</h4>
                        <div  id="duplicater">
                            <div class="row mb-4">
                                <div class="col-md-6 col-sm-8">
                                    <h6>Trade Name</h6>
                                    <select name="inputs[0][drugs_id]" class="form-control " required>
                                ...
                                <div class="col-md-6 col-sm-8">
                                    <h6>Unit (Mg/Ml)</h6>
                                    <input type="text" name="inputs[0][unit]" class="form-control" placeholder="Mg/Ml">
                                </div>
                            </div>   
                            <div>
                                <br/>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-6 col-sm-8">
                                    ...
                                    <input type="text" name="inputs[0][dose]" class="form-control" placeholder="Dose">
                                </div>
                                <div class="col-md-6 col-sm-8">
                                    <h6>Duration (Days)</h6>
                                    <input type="text" name="inputs[0][duration]" class="form-control" placeholder="Duration">
                                </div>
                            </div>
                            <hr>    
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="text-end mt-4">
                        <button type="submit" class="btn btn-primary mt-2 mb-2 btn-no-effect">Save Prescription</button>
                    </div>
                </div>
            </div>
    </div>
