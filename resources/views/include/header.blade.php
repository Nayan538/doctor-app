            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="hr" data-bs-parent="#accordionExample">
                        <li>
                            <a href="{{ route('staffProfile') }}">Patient Profiles</a>
                        </li>
                        <li>
                            <a href="{{ route('allDrugs') }}">All Drugs</a>
                        </li>
                        <li>
                            <a href="{{ route('allPrescription') }}">All Prescription</a>
                        </li>
                    </ul>
                </li> 
                @endif
